...
def processing(path_dwi_input, path_binary_mask, path_output, path_bval, path_bvec, mapping):
    ...
    bunddle_rules = [(('AAN', [7, 9]), ('Morel', [14, 52]), ('HarvardOxfordCort', indexHarvardOxfortCortical)),
             (('Morel', [14, 52]), ('HarvardOxfordCort', indexHarvardOxfortCortical))]

    #(('AAN', [7, 9]), ('HypothalamusAtlas', [1, 2, 3]), ('HarvardOxfordCort', indexHarvardOxfortCortical)),
    ...
    roi_rules = {'AAN':[7, 9], 'Morel':[14, 52], 'HypothalamusAtlas':[1, 2, 3]}
