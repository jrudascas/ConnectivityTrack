...
def processing(path_dwi_input, path_binary_mask, path_output, path_bval, path_bvec, mapping):
    ...
    path_atlas_1 = p.registration_atlas_to(d.aan_atlas, path_output, affine, mapping)
    path_atlas_2 = p.registration_atlas_to(d.morel_atlas, path_output, affine, mapping)
    path_atlas_3 = p.registration_atlas_to(d.hypothalamus_atlas, path_output, affine, mapping)
    path_atlas_4 = p.registration_atlas_to(d.harvard_oxford_cort_atlas, path_output, affine, mapping)
    ...
    atlas_dict = {'Morel': path_atlas_2, 'AAN': path_atlas_1, 'HarvardOxfordCort': path_atlas_4,
                  'HypothalamusAtlas': path_atlas_3}
